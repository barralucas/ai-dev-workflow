---
description: 'Padrões de Git — branches, commits (Conventional Commits), PRs, code review.'
applyTo: '**'
---
...
> Em PT é aceitável `feat/us-XXX-listar-partidas`. Mantenha consistência no projeto.
...
- Release notes geradas a partir de Conventional Commits (semantic-release ou manual).

## 7. Hooks

Sugestão (Husky/Lefthook):
